...
select 'ALTER TABLE ' + a.base + '.'+a.esquema+'.'+a.tabela +' ADD '+a.coluna+' '+a.tipo+
...
left join t_tab_ignore as c on c.base = a.base and c.esquema = a.esquema and c.tabela = a.tabela
where c.base is null and b.base is null
and a.coluna not like '%rowversion%'